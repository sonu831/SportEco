        ...
        <View style={{ flex: 1 }}>
            ...
            >
                <Marker
                    ...
                    icon={<MaterialIcons name='location-pin' size={20} color={Colors.red} />}
                />
            </MapView>
            <SearchBox
                style={{
            ...
            />
            <View style={{ height: 150, backgroundColor: Colors.white, padding: 10, alignItems: 'center' }}>
                <View style={{ flexDirection: 'row', width: '85%' }}>
                    <MaterialIcons name='location-pin' size={35} color={Colors.red} style={{ paddingHorizontal: 5 }} />
                    <View>
